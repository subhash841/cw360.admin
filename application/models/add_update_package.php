                        ...
                        <form name="addUpdatePackage" id="addUpdatePackage" method="POST" action="<?= base_url() ?>Packages/create_update">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <label for="radio_type_premium">Points</label>
                                ...
                                ?>>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="package_price" id="package_price"  maxlength="10" value="<?= @$price ?>"  placeholder="Points">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <div class="row">
                                                 ...
                                                 <input type="hidden" name="slim_update" value="<?= @$image ?>">
