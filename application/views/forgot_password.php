...
<html>
    ...
    <body class="login-page">
        <div class="login-box">
            ...
            <div class="card">
                <div class="body">
                    <form id="sign_in" method="POST" action="Forgot_password">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control" name="username" placeholder="Register Email" required autofocus value="<?= set_value('username') ?>">
                            </div>
                            <label id="password-error" class="error" for="password"><?= form_error('username') ?></label>
