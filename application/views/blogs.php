                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="table-responsive">
                            <table id="exportOptions" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                <thead>
                                    <tr>
                                        <th>#Sr.</th>
                                        <th>Title</th>
                                        ...
                                        <th class="text-center" width="100">Sender</th>
                                        <th class="text-center notexport" width="50">View</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    foreach ( $pending_blog_list as $key => $list ):
                                            $num = $key + 1;
                                            $user_id = $list[ 'user_id' ] == null ? "0" : $list[ 'user_id' ];
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable custom-exportable">
                                <thead>
                                    <tr>
                                        <th>#Sr</th>
                                        <th>Title</th>
                                        <th width="400">Description</th>
                                        <th class="text-center" width="100">Date</th>
                                        <th class="text-center notexport">Sender</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ( $blog_list as $key => $list ):
                                            $num = $key + 1;
                                            $newvalue = $list[ 'is_active' ] == 1 ? "checked" : "";
                                            $user_id = empty($list[ 'user_id' ]) ? "0" : $list[ 'user_id' ];
                                            $description = str_replace( '\\', '/', $list[ 'description' ] );
                                            $description = preg_replace( "/<style(.*)<\/style>/iUs", "", $description );
                                            $description = str_replace( "&nbsp;", " ", $description );
                                            ...
                                            echo '<td>
                                                    <a class="switch changeactiveblog" data-id="' . $list[ 'id' ] . '" data-type="blogs" data-status=' . $list[ 'is_active' ] . '>
...
<script>
    ...
    $(document).on('change', '.changeactiveblog', function (e) {
        var _this = $(this);
        console.log(id);
