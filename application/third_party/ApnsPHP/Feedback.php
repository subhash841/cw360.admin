...
//					$this->messages = "INFO: New feedback tuple: timestamp=%d (%s), tokenLength=%d, deviceToken=%s.",$aFeedback['timestamp'], date('Y-m-d H:i:s', $aFeedback['timestamp']),$aFeedback['tokenLength'], $aFeedback['deviceToken'];
					unset($aFeedback);
				}
			}
			...
			if ($nChangedStreams === false) {
				...
				$this->messages = "WARNING: Unable to wait for a stream availability.~~";
				break;
			}
		}
